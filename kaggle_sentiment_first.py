...
from keras.layers import Embedding,Dense,Dropout,Activation,LSTM,Input
...
trn_data=pd.read_csv("train.tsv",delimiter='\t')
...
model.summary()
model.fit(x=b_padded,y=y,epochs=10,batch_size=512)
